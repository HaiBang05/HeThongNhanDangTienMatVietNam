...
raw_folder = "data/" # lấy dữ liệu từ file data đã được tạo từ file makedata
...
vgghist=vggmodel.fit(aug.flow(X_train, y_train, batch_size=64),
                    epochs=50,
                    validation_data=aug_val.flow(X_test,y_test,batch_size=64),
